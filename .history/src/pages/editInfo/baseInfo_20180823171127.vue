<template>
    <div class="base-info-pages">
        <group style="pading:0 30px;">
            <x-input title="姓名"
                     :max="10" 
required text-align="right" placeholder="请输入姓名,10位以内" placeholder-align="right"></x-input>
            <selector title="性别"
                      direction="rtl" 
:options="[{key: '0', value: '男'}, {key: '1', value: '女'}]"></selector>
            <datetime v-model="birthday"
                      @on-change="change" 
:title="'生日'" :min-year="1900" :max-year="thisYear" @on-confirm="onConfirm"></datetime>
        </group>
        <group>
        ...
        <group>
            ...
            <x-input title="现居住地址"
                     required 
text-align="right" placeholder="请输入现居住地址" placeholder-align="right"></x-input>
            <x-input title="联系电话"
                     required 
text-align="right" placeholder="请输入11位手机号" is-type="china-mobile" placeholder-align="right"></x-input>
            ...
            <x-input title="近期年收入"
                     required 
text-align="right" placeholder="请输入年收入" type="number" placeholder-align="right"></x-input>
        </group>
        <group title="选择保险行业原因">
            <x-textarea :max="100"
                        :height="176" 
required :placeholder="'5-100字'"></x-textarea>
        </group>
